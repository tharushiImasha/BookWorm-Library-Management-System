...
public class UserProfileController {
    ...
    private void setCellValueFactory() {
        ...
        colBorrowedDate.setCellValueFactory(new PropertyValueFactory<>("author"));
        colDueDate.setCellValueFactory(new PropertyValueFactory<>("desc"));
    }
    ...
    private void loadAllBooks() {
        try {
            ...
            for(BorrowedDetailsDto dto : dtoList){
                ...
                var tm = new BorrowedDetailsTm(dto.getBorrowedDetailPK(), dto.getBorrowedDate(), dto.getDueDate());
